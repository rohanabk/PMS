...
<body>
  ...
  <div class="page-content">
    <div id="main-content" style="padding-left:10px;">
      <h5 style="padding-left:10px;">Submit Synopsis</h5>

      <div class="row">
        <h6><b>Details:</b></h6>
        <p>Marks for project:10</p>
        <p>Project Theme(if Any):Web application</p>
        <p>Due Date for Synopsis:15/03/2019</p>
        <p>Minimum members in a group: 2</p>
        <p>Maximum members in a group: 4</p>
      </div>
      <div class="row">
      ...
      <div class="row">
        <div class="input-field col s6">
          <input type="text">
          <label for="email">member 1 usn</label>
        </div>
        <div class="input-field col s6">
          <input type="text">
          <label for="email">member 2 usn</label>
        </div>
        <div class="input-field col s6">
          <input type="text">
          <label for="email">member 3 usn</label>
        </div>
        <div class="input-field col s6">
          <input type="text">
          <label for="email">member 4 usn</label>
        </div>
      </div>
      <div class="row">
        <h6>File size < 2 MB</h6> <h6>File types allowed : PDF,DOCX,DOC,ODT.</h6>
      </div>
