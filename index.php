...
<body>
  ...
  <div class="page-content">
    <div id="main-content">
      <h5 style="padding-left:10px;">Create Class</h5>
      <h7>Note: The class created will be automatically deleted along with all projects associated after 365days</h7>
      <div class="row">
              ...
              <div class="input-field col s6">
                <input type="text">
                <label for="email">Due Date for synopsis submission</label>
              </div>

              <div class="input-field col s6">
                <input type="text">
                <label for="email">Due Date for Project submission</label>
              </div>

              <div class="input-field col s6">
                <input type="text">
                <label for="email">Minimum number of members in a group</label>
              </div>

              <div class="input-field col s6">
                <input type="text">
                <label for="email">Maximum number of members in a group</label>
              </div>

              <div class="input-field col s6">
                <input type="text">
                <label for="email">Marks for project</label>
              </div>

              <div class="input-field col s6">
                <input type="text">
                <label for="email">Project Theme(optional)</label>
              </div>
            </div>
          <div class="row">
            <button type="button" class="waves-effect waves-light btn" name="button">Create</button>
          </div>
      </div>
    </div>
